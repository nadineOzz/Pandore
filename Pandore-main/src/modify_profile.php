...
<body>
  ...
  <div id="content" name="content">
        <form action="forms/form_modify_profile.php" method="post">
    ...
    <div class="container rounded mt-5" style="background-color: #101047">
        <div class="row">
            <div class="col-md-4 border-right">
              <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" src="https://www.bootdey.com/app/webroot/img/default-avatar.png" width="150"><span></span></div>
            </div>
            ...
            <div class="p-3 py-5">
               <div class="d-flex justify-content-between align-items-center mb-3">
                   <div class="d-flex flex-row align-items-center back"><i class="fa fa-long-arrow-left mr-1 mb-1"></i>
                        <h6 style="color: #ffff">Profile Details</h6>
                   </div>
               </div>


            <div class="row mt-2">
                <div class="col-md-6"><input type="text" class="form-control" id="lastName" name="lastName" autocomplete="given-name" placeholder="Last Name" autoFocus></div>
                <div class="col-md-6"><input type="text" class="form-control" id="firstName" name="firstName" autocomplete="family-name" placeholder="First Name"></div>
            </div>

            <div class="row mt-3">
                <div class="col-md-6"><input type="email" class="form-control" id="email" name="email" autocomplete="email" placeholder="<?php echo $_SESSION['email']; ?>"></div>
                <div class="col-md-6"><input type="tel" class="form-control" id="phoneNumber" name="phoneNumber" placeholder="<?php echo $_SESSION['phoneNumber']; ?>" pattern="^((\+\d{1,3}(-| )?\(?\d\)?(-| )?\d{1,5})|(\(?\d{2,6}\)?))(-| )?(\d{3,4})(-| )?(\d{4})(( x| ext)\d{1,5}){0,1}$"></div>
            </div>

            <div class="row mt-3">
                <div class="col-md-6"><input type="text" class="form-control" id="password" name="password" placeholder="••••••••••" autocomplete="new-password"></div>
            </div>

            <div class="mt-5 text-right">
                <button type="submit" class="btn btn-primary profile-button" name="btnModifyProfile" id="btnModifyProfile" style="background-color: #5582C8">Save Profile</button>
            </div>
            </div>
        </div>
        </div>
