...
$dataForms2 = array(
    ...
    array("label" => "Résultat Net", "y" => $dataAVG['avg_resultatNet']),
...
$dataRatio2 = array(
    ...
    array("label" => "Rentabilité d'Exploitation", "y" => $dataAVG['avg_rentabiliteExploitation']),
    array("label" => "Rentabilité Globale", "y" => $dataAVG['avg_rentabiliteGlobale']),
